...
public class AuthServiceTests
{
    ...
    {
        var response = await _sut.RegisterAsync(new RegisterRequest { Name = "New User", Email = "New.User@Example.com", Password = "Password123!" });
    ...
    {
        await _sut.RegisterAsync(new RegisterRequest { Name = "User", Email = "user@example.com", Password = "Password123!" });
    ...
    {
        await _sut.RegisterAsync(new RegisterRequest { Name = "User One", Email = "user@example.com", Password = "Password123!" });

        var act = () => _sut.RegisterAsync(new RegisterRequest { Name = "User Two", Email = "USER@example.com", Password = "Different1!" });
    ...
    [Fact]
    public async Task LoginAsync_ValidCredentials_ReturnsTokenAndName()
    {
        await _sut.RegisterAsync(new RegisterRequest { Name = "User", Email = "user@example.com", Password = "Password123!" });
